 ...
 * @author TTGETERZI
 */
@DownloadEngine(systemType = "ESSR_GGSN", measType = "PM", operatorName = "VODAFONE")
public class EssrGgsnPmDownloadEngine extends DefaultTimeBasedEngine {

    public EssrGgsnPmDownloadEngine(ServerIpList eachIp) {
        super(eachIp);
    }
